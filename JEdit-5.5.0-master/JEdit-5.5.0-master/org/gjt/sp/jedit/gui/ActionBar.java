...
public class ActionBar extends JToolBar
{
	...
	public class ActionTextField extends HistoryTextField
	{
		boolean repeat;
		boolean nonDigit;
                private Map<Integer, KeyEventProcessor> processorMap;
		ActionTextField()
		{
			super("action");
        ...
        processorMap.put(KeyEvent.KEY_TYPED, new KeyTypedProcessor());
        processorMap.put(KeyEvent.KEY_PRESSED, new KeyPressedProcessor());
    }
        ...
        KeyEventProcessor processor = processorMap.get(evt.getID());
        if (processor != null) {
            processor.process(evt, this);
        } else {
            superProcessKeyEvent(evt);
        }
    }

    void superProcessKeyEvent(KeyEvent evt) {
